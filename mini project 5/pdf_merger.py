...
def merge_files():
    ...
    if selected_files:
        default_name = os.path.splitext(os.path.basename(selected_files[0]))[0] + "_merged.pdf"
    ...
    try:
        ...
        messagebox.showinfo("Success", f"PDF files merged successfully.\nSaved to:\n{output_path}")
...
merge_btn = tk.Button(root, text="Merge PDFs", width=20, command=merge_files, bg="green", fg="white")
